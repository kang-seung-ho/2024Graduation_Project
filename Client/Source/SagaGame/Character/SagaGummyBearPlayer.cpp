...
ASagaGummyBearPlayer::ASagaGummyBearPlayer()
{
	...
	{
		r_arm->SetRestCollection(r_armAsset.Object);
	}
	...
	{
		r_leg->SetRestCollection(r_legAsset.Object);
	}
	...
	{
		l_arm->SetRestCollection(l_armAsset.Object);
	}
	...
	{
		l_leg->SetRestCollection(l_legAsset.Object);
	}
	...
	{
		UE_LOG(LogSagaGame, Log, TEXT("FoundAsset"));
